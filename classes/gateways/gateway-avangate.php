...
//		add_action( 'woocommerce_api_wc_gateway_paypal', array( $this, 'check_ipn_response' ) );
    ...
    function init_form_fields() {
    	...
    	$this->form_fields = array(
			...
			self::MERCHANT_CODE => array(
							'title' => __( 'MerchantCode', 'woocommerce' ),
							'type' => 'text',
							'description' => __( 'Your merchant identifier (received from Avangate).', 'woocommerce' ),
							'default' => '',
							'desc_tip'      => true,
						),
